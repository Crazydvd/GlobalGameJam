...
public class PlayerSpawn : MonoBehaviour
{
	...
	void Shepherd()
	{
		...
		Instantiate(Player1, filteredList.GetRandomItem() + Vector3.up * 2, Quaternion.identity);
		Instantiate(Player2, filteredList.GetRandomItem() + Vector3.up * 2, Quaternion.identity);
	}
}